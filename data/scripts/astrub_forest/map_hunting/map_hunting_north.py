class North:
    ...
    data = [
        ...
        {"3,-25" : {"top"    : (500, 56),  "map_type": "traversable"}},

        {"3,-26" : {"top"    : (699, 55),  "map_type": "fightable",
                    "cell"   : [(568, 236),(535, 219),(602, 423),(635, 440)]}},

        {"3,-27" : {"left"   : (6, 341),   "map_type": "traversable"}},
        ...
        {"1,-27" : {"left"   : (4, 410),   "map_type": "fightable",
        ...
        {"-2,-26": {"right"  : (926, 310), "map_type": "fightable",
                    "cell"   : [(504, 474),(540, 492),(802, 287),(835, 304)]}},

        {"-1,-26": {"right"  : (926, 308), "map_type": "traversable"}},

        {"0,-26" : {"right"  : (922, 411), "map_type": "traversable"}},

        {"1,-26" : {"right"  : (926, 342), "map_type": "fightable",
                    "cell"   : [(533, 187),(601, 186),(667, 390),(634, 407)]}},

        {"2,-26" : {"right"  : (924, 342),  "map_type": "fightable",
        ...
        {"-2,-25" : {"top"   : (499, 57),  "map_type": "traversable"}},

        {"1,-25"  : {"top"   : (633, 59),  "map_type": "traversable"}},

        {"2,-25"  : {"top"   : (365, 55),  "map_type": "traversable"}},
    ]
