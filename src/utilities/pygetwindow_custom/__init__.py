...
class BaseWindow:
    ...
    def _setupRectProperties(self):
        ...
        self._rect = pyrect.Rect(r.left, r.top, r.right - r.left, r.bottom - r.top, onChange=self._onChange, onRead=self._onRead)

    def _onRead(self, attrName):
        r = self._getWindowRect()
    ...
    def _onChange(self, oldBox, newBox):
