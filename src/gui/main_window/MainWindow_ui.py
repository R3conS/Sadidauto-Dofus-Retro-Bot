...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.character_name_line_edit = CharacterNameLineEdit(self.frame_2)
        self.character_name_line_edit.setObjectName(u"character_name_line_edit")

        self.verticalLayout_2.addWidget(self.character_name_line_edit)

        self.server_combo_box = ServerComboBox(self.frame_2)
        self.server_combo_box.setObjectName(u"server_combo_box")

        self.verticalLayout_2.addWidget(self.server_combo_box)

        self.script_combo_box = ScriptComboBox(self.frame_2)
        self.script_combo_box.setObjectName(u"script_combo_box")

        self.verticalLayout_2.addWidget(self.script_combo_box)
